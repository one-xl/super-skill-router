...
# Example output: /mnt/internal-skills/docx/scripts/document.py
# Skill root is: /mnt/internal-skills/docx
```

**Run your script with PYTHONPATH** set to the docx skill root:

```bash
PYTHONPATH=/mnt/internal-skills/docx python your_script.py
```
