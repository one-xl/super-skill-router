...
```bash
# In your project root, install the upstream skill into .agents/internal-skills/
...
```
.agents/internal-skills/animate-text/assets/effects/<id>.json   # per-library implementation recipe
.agents/internal-skills/animate-text/assets/specs/<id>.json     # portable motion contract
```
