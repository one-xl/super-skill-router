...
Four phases, four spring feels, four ease choices. The complete spring → ease mapping table lives in [hyperframes-animation/INSTRUCTION.md](../INSTRUCTION.md); this blueprint's defaults are:
