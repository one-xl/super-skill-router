...
Four entry feels, one morph driver, one continuous loop. The full mapping lives in [hyperframes-animation/INSTRUCTION.md](../INSTRUCTION.md); this blueprint's choices:
