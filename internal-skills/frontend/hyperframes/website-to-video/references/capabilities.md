...
- **TextPlugin** — text mutation in `tl.call` (internal-skills/gsap/references/effects.md)
- **MotionPathPlugin** — curve-constrained tweens (internal-skills/hyperframes/references/techniques.md)
...
Documented in internal-skills/hyperframes/references/transitions/ across 14 category files. All GSAP-driven, none mixable with shader transitions in same composition.
...
Documented in internal-skills/hyperframes/references/html-in-canvas-patterns.md (504 lines).
...
(From internal-skills/hyperframes/references/techniques.md)
...
## 23. References inventory (internal-skills/hyperframes/references/)
