...
skill_root = next((p for p in [
    ...
    os.path.abspath(".agent/internal-skills/jianying-editor"),
    os.path.abspath(".trae/internal-skills/jianying-editor"),
    os.path.abspath(".claude/internal-skills/jianying-editor"),
