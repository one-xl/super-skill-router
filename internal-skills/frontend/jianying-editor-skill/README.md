...
```bash
git clone https://github.com/luoluoluo22/jianying-editor-skill.git .agent/internal-skills/jianying-editor
```

**🚀 Trae IDE:**
```bash
git clone https://github.com/luoluoluo22/jianying-editor-skill.git .trae/internal-skills/jianying-editor
```

**🧠 Claude Code:**
```bash
git clone https://github.com/luoluoluo22/jianying-editor-skill.git .claude/internal-skills/jianying-editor
```

**💻 Cursor / VSCode / 通用:**
```bash
# 通用方式：安装到根目录 include 列表
git clone https://github.com/luoluoluo22/jianying-editor-skill.git internal-skills/jianying-editor
```
...
```bash
cd .agent/internal-skills/jianying-editor
git pull
```
