...
```bash
SKILL_DIR="$HOME/.agents/internal-skills/serenity-skill"
mkdir -p "$SKILL_DIR"
...
```bash
SKILL_DIR=".agents/internal-skills/serenity-skill"
mkdir -p "$SKILL_DIR"
cp -R SKILL.md LICENSE references assets scripts examples agents "$SKILL_DIR"/
```
...
```bash
SKILL_DIR="$HOME/.claude/internal-skills/serenity-skill"
mkdir -p "$SKILL_DIR"
cp -R SKILL.md LICENSE references assets scripts examples agents "$SKILL_DIR"/
```
...
```bash
SKILL_DIR=".claude/internal-skills/serenity-skill"
mkdir -p "$SKILL_DIR"
cp -R SKILL.md LICENSE references assets scripts examples agents "$SKILL_DIR"/
```
...
```bash
SKILL_DIR="$HOME/.hermes/internal-skills/research/serenity-skill"
mkdir -p "$SKILL_DIR"
cp -R SKILL.md LICENSE references assets scripts examples agents "$SKILL_DIR"/
```
