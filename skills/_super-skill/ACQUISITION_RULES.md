...
2. `SUPER_SKILL_ROOT/_super-skill/SKILL_REGISTRY.md` 中缓存的可信来源。
...
```text
GET https://skills.sh/api/v1/skills/search?q=[query]&limit=5
```
...
```text
GET https://skills.sh/api/v1/skills/audit/{id}
```
